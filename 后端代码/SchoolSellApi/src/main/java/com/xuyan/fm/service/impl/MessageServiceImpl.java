...
import com.xuyan.fm.dao.MessageDao;
...
public class MessageServiceImpl implements MessageService {
    ...
    /**
     * 删除一条留言（带属主条件，只能删自己发的；原接口任何用户可删任意留言）
     */
    public boolean deleteMessage(Long userId, Long id){
        return messageDao.deleteByIdAndUser(id, userId)==1;
    }
