...
public class IdleItemModel implements Serializable {
    ...
    /**
     * 商品标签（逗号分隔，如：可爱,萌宠,包邮；点击可搜索同标签商品）
     */
    private String idleTags;

    /**
     * 审核未通过/违规原因（管理端填写，卖家可见）
     */
    ...
    /**
     * 库存数量（多件可售；下单不扣，付款时 -1，付款后取消回退 +1）
     */
    private Integer stock;

    /**
     * 销量（付款成功 +1；付款后取消 -1，下限 0）
     */
    ...
    public String getIdleTags() {
        return idleTags;
    }

    public void setIdleTags(String idleTags) {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getIdleTags() == null ? other.getIdleTags() == null : this.getIdleTags().equals(other.getIdleTags()))
            && (this.getIdleReason() == null ? other.getIdleReason() == null : this.getIdleReason().equals(other.getIdleReason()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getIdleTags() == null) ? 0 : getIdleTags().hashCode());
        result = prime * result + ((getIdleReason() == null) ? 0 : getIdleReason().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", idleTags=").append(idleTags);
        sb.append(", idleReason=").append(idleReason);
